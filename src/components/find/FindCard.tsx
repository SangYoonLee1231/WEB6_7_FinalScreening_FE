  ...
  return (
    <FindCardContainer className="flex flex-col gap-3">
      ...
      <div className="flex justify-between gap-10">
        ...
        <SubTitleAndData title="KDA" data={writer.gameAccount.kda.toString()} />
      </div>
      ...
      <div className="bg-accent/10 border-accent/50 flex flex-col gap-3.5 rounded-xl border px-4 py-2">
        ...
        <div className="flex justify-between">
          ...
          <BoxButton size="xs" tone="color" text="참여하기" />
        </div>
      </div>
    </FindCardContainer>
  );
...
function SubTitleAndData({ title, data }: { title: string; data: string }) {
  return (
    <h5 className="text-content-primary flex w-full items-center justify-between text-sm font-normal">
      {title}
